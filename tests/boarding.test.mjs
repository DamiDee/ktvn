...
const booking = { id: "ticket", bus_id: "bus", route_id: "route", status: "Confirmed", payment_status: "Free" };
const bus = { id: "bus", current_route_id: "route", status: "Available", state: "Boarding" };
const route = { id: "route", is_completed: false };
test("only confirmed, cleared tickets on the selected open bus may board", () => {
  ...
  assert.ok(boardingProblem(booking, bus, { ...route, is_completed: true }));
});
